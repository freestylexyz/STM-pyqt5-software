...
class myScan_(QWidget, Ui_Scan):
    ...
    def init_property(self):
        ...
        constant_current_seq = mySequence([0xd8], [500] , True)
        constant_current_seq.name = 'Basic constant current'
        constant_height_seq = mySequence([0xdc], [500] , True)
        constant_height_seq.name = 'Basic height current'
        constant_height_seq.feedback = False
        self.scan_seq_list = [constant_current_seq, constant_height_seq]
        self.dep_seq_list = []
        self.spc_seq_list = []
        self.scan_seq_selected = 0
