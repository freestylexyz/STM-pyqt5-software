...
from pyqtgraph import basestring
...
from pyqtgraph import isQObjectAlive
...
class CustomViewBox(GraphicsWidget):
    """
    ...
    * Item coordinate mapping methods
    ...
    def __init__(self, parent=None, border=None, lockAspect=False, enableMouse=True, invertY=False, enableMenu=True, name=None, invertX=False):
        ...
        *name*          (str) Used to register this ViewBox so that it appears
        ...
        # self.rbScaleBox.setBrush(fn.mkBrush(255,255,0,100))   # Dan 1/5/2021
    ...
    def mouseDragEvent(self, ev, axis=None):
        ...
        if ev.button() & (QtCore.Qt.LeftButton | QtCore.Qt.MidButton):
            ...
            self._resetTarget()                                               # Dan: commented on 1/5/2021, restored on 1/20/2021
            self.scaleBy(x=x, y=y, center=center)                             # Dan: commented on 1/5/2021, restored on 1/20/2021
            self.sigRangeChangedManually.emit(self.state['mouseEnabled'])     # Dan: commented on 1/5/2021, restored on 1/20/2021
    ...
    def updateScaleBox(self, p1, p2):
        ...
        scale = min(r.width(), r.height())  # Dan 1/5/2021
        self.rbScaleBox.scale(scale, scale) # Dan 1/5/2021
