...
class Ui_PointEditor(object):
    def setupUi(self, PointEditor):
        ...
        self.table_Content = QtWidgets.QTableWidget(PointEditor)
        self.table_Content.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.table_Content.setDragDropOverwriteMode(False)
        self.table_Content.setTextElideMode(QtCore.Qt.ElideMiddle)
        self.table_Content.setObjectName("table_Content")
        self.table_Content.setColumnCount(2)
        ...
        self.gridLayout.addWidget(self.table_Content, 0, 0, 1, 1)
