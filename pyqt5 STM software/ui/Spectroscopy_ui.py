...
class Ui_Spectroscopy(object):
    def setupUi(self, Spectroscopy):
        ...
        self.scrollBar_Channel_Graph.setMaximum(0)
        ...
        self.label_Channel_Graph.setMinimumSize(QtCore.QSize(0, 24))
        ...
        self.gridLayout_3.addWidget(self.scrollBar_point_Graph, 6, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.label_point_Graph, 6, 3, 1, 1)
        self.label_Pointer1_Graph = QtWidgets.QLabel(self.Graph)
        self.label_Pointer1_Graph.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_Pointer1_Graph.setObjectName("label_Pointer1_Graph")
        self.gridLayout_3.addWidget(self.label_Pointer1_Graph, 0, 3, 1, 1)
        self.label_Pointer2_Graph = QtWidgets.QLabel(self.Graph)
        self.label_Pointer2_Graph.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_Pointer2_Graph.setObjectName("label_Pointer2_Graph")
        self.gridLayout_3.addWidget(self.label_Pointer2_Graph, 1, 3, 1, 1)
        self.label_19 = QtWidgets.QLabel(self.Graph)
        self.label_19.setMaximumSize(QtCore.QSize(15, 16777215))
        self.label_19.setObjectName("label_19")
        self.gridLayout_3.addWidget(self.label_19, 0, 2, 1, 1)
        self.label_20 = QtWidgets.QLabel(self.Graph)
    ...
    def retranslateUi(self, Spectroscopy):
        ...
        self.label_Pointer1_Graph.setText(_translate("Spectroscopy", "0"))
        self.label_Pointer2_Graph.setText(_translate("Spectroscopy", "0"))
        self.label_19.setText(_translate("Spectroscopy", "Y:"))
        self.label_20.setText(_translate("Spectroscopy", "Y:"))
