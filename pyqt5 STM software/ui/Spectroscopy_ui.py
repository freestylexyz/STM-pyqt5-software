...
class Ui_Spectroscopy(object):
    def setupUi(self, Spectroscopy):
        ...
        self.graphicsView_2.setMinimumSize(QtCore.QSize(240, 240))
        ...
        self.gridLayout_3.addWidget(self.horizontalScrollBar_7, 5, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.label_13, 5, 3, 1, 1)
        ...
        self.graphicsView.setMinimumSize(QtCore.QSize(240, 240))
    ...
    def retranslateUi(self, Spectroscopy):
        ...
        self.comboBox.setItemText(0, _translate("Spectroscopy", "Bias"))
        self.comboBox.setItemText(1, _translate("Spectroscopy", "Z fine"))
