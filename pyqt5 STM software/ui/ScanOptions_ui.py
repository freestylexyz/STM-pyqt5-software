...
class Ui_ScanOptions(object):
    def setupUi(self, ScanOptions):
        ...
        self.gridLayout_8.addWidget(self.groupBox_Scan_ScanOptions, 0, 2, 2, 1)
        ...
        self.label_2 = QtWidgets.QLabel(self.groupBox_Tip_ScanOptions)
        ...
        self.label_4 = QtWidgets.QLabel(self.groupBox_Tip_ScanOptions)
        self.label_4.setObjectName("label_4")
        self.gridLayout_4.addWidget(self.label_4, 1, 2, 1, 1)
        self.spinBox_SaferIset_Tip = QtWidgets.QDoubleSpinBox(self.groupBox_Tip_ScanOptions)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinBox_SaferIset_Tip.sizePolicy().hasHeightForWidth())
        self.spinBox_SaferIset_Tip.setSizePolicy(sizePolicy)
        self.spinBox_SaferIset_Tip.setMinimumSize(QtCore.QSize(80, 20))
        self.spinBox_SaferIset_Tip.setObjectName("spinBox_SaferIset_Tip")
        self.gridLayout_4.addWidget(self.spinBox_SaferIset_Tip, 1, 1, 1, 1)
        self.label = QtWidgets.QLabel(self.groupBox_Tip_ScanOptions)
        self.label.setObjectName("label")
        self.gridLayout_4.addWidget(self.label, 0, 0, 1, 1)
        self.gridLayout_8.addWidget(self.groupBox_Tip_ScanOptions, 0, 1, 1, 1)
        ...
        self.label_24 = QtWidgets.QLabel(self.groupBox_Feedback_ScanOptions)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollBar_Advance_Feedback = QtWidgets.QScrollBar(self.groupBox_Feedback_ScanOptions)
        self.scrollBar_Advance_Feedback.setOrientation(QtCore.Qt.Horizontal)
        self.scrollBar_Advance_Feedback.setObjectName("scrollBar_Advance_Feedback")
        self.gridLayout_7.addWidget(self.scrollBar_Advance_Feedback, 3, 0, 1, 4)
        self.spinBox_Advance_Feedback = QtWidgets.QSpinBox(self.groupBox_Feedback_ScanOptions)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinBox_Advance_Feedback.sizePolicy().hasHeightForWidth())
        self.spinBox_Advance_Feedback.setSizePolicy(sizePolicy)
        self.spinBox_Advance_Feedback.setMinimumSize(QtCore.QSize(110, 20))
        self.spinBox_Advance_Feedback.setObjectName("spinBox_Advance_Feedback")
        self.gridLayout_7.addWidget(self.spinBox_Advance_Feedback, 2, 1, 1, 1)
        self.label_26 = QtWidgets.QLabel(self.groupBox_Feedback_ScanOptions)
        self.label_26.setObjectName("label_26")
        self.gridLayout_7.addWidget(self.label_26, 2, 2, 1, 1)
        self.gridLayout_8.addWidget(self.groupBox_Feedback_ScanOptions, 3, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.groupBox_Delay_ScanOptions, 1, 0, 3, 2)
        ...
        self.gridLayout_8.addWidget(self.widget_4, 2, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.OrderandDirection, 0, 0, 1, 1)
