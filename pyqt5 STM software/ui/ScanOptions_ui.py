...
class Ui_ScanOptions(object):
    def setupUi(self, ScanOptions):
        ...
        self.gridLayout_8.addWidget(self.groupBox_Delay_ScanOptions, 1, 0, 2, 2)
        ...
        self.gridLayout_8.addWidget(self.groupBox_Feedback_ScanOptions, 2, 2, 1, 1)
