...
class Ui_ScanOptions(object):
    def setupUi(self, ScanOptions):
        ...
        self.spinBox_LineControl_Delay.setMinimum(10000)
        ...
        self.spinBox_LineOFF_Delay.setProperty("value", 1000)
        ...
        self.spinBox_LineON_Delay.setProperty("value", 10000)
        ...
        self.spinBox_Retract_Tip.setMinimum(-32768)
        self.spinBox_Retract_Tip.setMaximum(32767)
        ...
        self.spinBox_SaferIset_Tip.setDecimals(5)
        self.spinBox_SaferIset_Tip.setMinimum(0.001)
        self.spinBox_SaferIset_Tip.setMaximum(100.0)
        self.spinBox_SaferIset_Tip.setProperty("value", 0.1)
        ...
        self.label_13 = QtWidgets.QLabel(self.groupBox_Tip_ScanOptions)
        self.label_13.setObjectName("label_13")
        self.gridLayout_4.addWidget(self.label_13, 2, 0, 1, 1)
        self.spinBox_SaferBias_Tip = QtWidgets.QDoubleSpinBox(self.groupBox_Tip_ScanOptions)
        self.spinBox_SaferBias_Tip.setDecimals(7)
        self.spinBox_SaferBias_Tip.setMinimum(-10.0)
        self.spinBox_SaferBias_Tip.setMaximum(10.0)
        self.spinBox_SaferBias_Tip.setProperty("value", 0.1)
        self.spinBox_SaferBias_Tip.setObjectName("spinBox_SaferBias_Tip")
        self.gridLayout_4.addWidget(self.spinBox_SaferBias_Tip, 2, 1, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.groupBox_Tip_ScanOptions)
    ...
    def retranslateUi(self, ScanOptions):
        ...
        self.label_13.setText(_translate("ScanOptions", "Safer Bias"))
        self.label_14.setText(_translate("ScanOptions", "V"))
