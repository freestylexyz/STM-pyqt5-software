...
class Ui_DataProcessing(object):
    def setupUi(self, DataProcessing):
        ...
        self.checkBox_Scanner = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_Scanner.setObjectName("checkBox_Scanner")
        self.gridLayout_2.addWidget(self.checkBox_Scanner, 0, 0, 1, 1)
    ...
    def retranslateUi(self, DataProcessing):
        ...
        self.checkBox_Scanner.setText(_translate("DataProcessing", "Show scanner"))
import logo_rc
